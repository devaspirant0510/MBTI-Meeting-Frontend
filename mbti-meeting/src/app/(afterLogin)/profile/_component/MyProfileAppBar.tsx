...
const MyProfileAppBar = () => {
    ...
    const onClickProfileUpdateButton = useCallback(() => {
        router.push('/profile/my/update');
    }, []);
    if (isLoading) {
        return <>loading</>;
    }
    ...
    return (
        <div className={'p-4 mt-4 flex flex-col'}>
            ...
            <div className={'flex justify-between items-start mt-2'}>
                ...
                <div>
                    <ProfileImageAvatar member={data!.data!.member!} constantSize={100} />
            ...
            <div className={'flex'}>
                <Button className={'m-2'} fullWidth onClick={onClickProfileUpdateButton}>프로필편집</Button>
